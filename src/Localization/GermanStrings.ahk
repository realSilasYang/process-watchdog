...
class GermanStrings {
    static Create() {
        ...
        catalog.Set("监控项不能指向文件夹：{1}", "Ein überwachter Eintrag darf nicht auf einen Ordner verweisen: {1}")
